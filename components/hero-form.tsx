    ...
    return(
        <div className="w-full flex-col flex justify-center items-center p-4 h-screen min-h-fit">
            <div className="flex flex-col justify-baseline lg:justify-end lg:items-end items-baseline gap-14">
                <h1 className="text-8xl lg:text-9xl max-sm:text-5xl font-heading">The world's most simple URL shortener.</h1>

                <div className="w-full lg:max-w-114 h-fit flex-col flex justify-end items-end gap-14">
